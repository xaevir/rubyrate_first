# project noname (0.0.1) configured on Wed Mar 14 01:48:53 2012 by
# waf 1.5.16 (abi 7, python 20502f0 on linux2)
...
[0m/usr/bin/ld: Release/test_1.o: undefined reference to symbol 'RAND_bytes@@OPENSSL_0.9.8'
/usr/bin/ld: note: 'RAND_bytes@@OPENSSL_0.9.8' is defined in DSO /usr/lib/libcrypto.so.0.9.8 so try adding it to the linker command line
/usr/lib/libcrypto.so.0.9.8: could not read symbols: Invalid operation
collect2: ld returned 1 exit status
['/usr/bin/g++', 'Release/test_1.o', '-o', '/srv/http/rubyrate/node_modules/bcrypt/build/.conf_check_0/testbuild/Release/testprog', '-L/lib', '-L/usr/lib', '-L/usr/local/lib', '-L/opt/local/lib', '-L/usr/sfw/lib', '-Wl,-Bdynamic', '-lssl']
